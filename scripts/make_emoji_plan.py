...
BASE_LANDMARKS = {
    "ear_l": [58, 54], "ear_r": [122, 54],       # 頭の左右に付く小さな丸耳
    "eye_l": [72, 70], "eye_r": [108, 70],       # ×に縫い留めたボタンの目
    "nose": [90, 80], "mouth": [90, 88],
    "foot_l": [74, 150], "foot_r": [106, 150],
    "tail": [126, 134],                          # 先に玉結びのある太い尻尾
}

STAND_BBOX = {"w": 96, "h": 108, "cx": 90, "baseline_y": 150}
SEAT_BBOX  = {"w": 112, "h": 88, "cx": 90, "baseline_y": 150}
LIE_BBOX   = {"w": 132, "h": 76, "cx": 90, "baseline_y": 150}

ROI_FEET   = [76, 138, 28, 16]   # 接地足
ROI_HIP    = [78, 120, 24, 16]   # 腰
ROI_TORSO  = [78, 106, 24, 16]   # 胴体中心
ROI_SEAT   = [76, 128, 28, 20]   # 尻・接地面
ROI_LIE    = [60, 134, 60, 16]   # 横向きの接地面
...
ITEMS = [
 dict(n="001", meaning="ありがとう", cat=C, comp="full_body", tags=["full_body"],
  ...
  moving=["head","body","left_arm","right_arm","stitch_line"], fixed=["legs_or_feet"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="腰から折れる上半身と、遅れて張り直る輪郭のステッチ",
  cues=dict(eyes="穏やかに細めた三日月", brows="わずかに下げた水平", mouth="小さく閉じた弧",
            cheeks="淡い赤み", hands="両手を胸元へ寄せて重ねる", posture="直立からわずかに前傾",
            prop="", effect="輪郭のステッチが均等に締まる"),
  story=["胸元で両手を重ね、正面を向いた完成した感謝の姿勢",
         "背筋をわずかに反らして力を溜め、背中のステッチが伸びる",
         "腰を支点に上半身が前へ倒れる途中。頭は膝方向を向く",
         "最も深いお辞儀。頭頂が34px下がり、首元のリボンが前方へ垂れる",
         "上半身が戻り始め、リボンだけが遅れて前で揺れる",
         "直立に近づき、リボンが振り子の余韻で小さく戻る"],
  pat="F01 と F12 の頭頂Y座標が34px以上異なる",
  intent="感謝を丁寧に伝える", sil="直立・胸元で手を重ねた縦長",
  effect_name="ステッチの均等な締まり", prop_name="", deform="腰から上の前傾",
 ...
 dict(n="002", meaning="お願い", cat=C, comp="face_centered", tags=["face_centered","upper_body"],
  ...
  moving=["left_arm","right_arm","head","face_parts"], fixed=["legs_or_feet","body","tail"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="顔の前で合わせた両手",
  cues=dict(eyes="上目づかいの大きな丸", brows="八の字に上げる", mouth="すぼめた小さな楕円",
            cheeks="淡い赤み", hands="顔の前で合掌", posture="やや前かがみ",
            prop="", effect="手元のステッチが小刻みに詰まる"),
  ...
  effect_name="手元ステッチの詰まり", prop_name="", deform="肘の伸展",
 ...
 dict(n="005", meaning="はい", cat=C, comp="full_body", tags=["full_body"],
  ...
  moving=["head","stitch_line","right_arm","face_parts"], fixed=["legs_or_feet","body","left_arm"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="真上へ伸ばした右手と頭の上下",
  cues=dict(eyes="大きく開いた丸", brows="上げた水平", mouth="開いた小さな楕円",
            cheeks="", hands="右手を真上へまっすぐ上げる", posture="背筋を伸ばした直立",
            prop="", effect="上げた腕側のステッチが引き締まる"),
  ...
  effect_name="片側ステッチの引き締まり", prop_name="", deform="首の屈伸",
 ...
 dict(n="006", meaning="いいね", cat=C, comp="upper_body", tags=["upper_body"],
  ...
  moving=["right_arm","face_parts","head"], fixed=["legs_or_feet","body","left_arm","tail"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="手前へ突き出した大きな親指",
  cues=dict(eyes="細めた笑い目", brows="上げた水平", mouth="開いた笑いの弧",
            cheeks="赤み", hands="右手の親指を立てて手前へ出す", posture="やや胸を張る",
            prop="", effect="親指まわりのステッチが太く締まる"),
  ...
  effect_name="親指まわりのステッチ強調", prop_name="", deform="奥行き方向の拡大",
...
ITEMS += [
 ...
 dict(n="008", meaning="待って", cat=C, comp="face_centered", tags=["face_centered","upper_body"],
  ...
  effect_name="手のひらステッチの締まり", prop_name="", deform="胴体の反動",
 ...
 dict(n="009", meaning="おつかれ", cat=C, comp="seated_lying_back", tags=["seated_lying_back","prop_acting"],
  ...
  cues=dict(eyes="穏やかに細める", brows="力を抜いた水平", mouth="小さく閉じる",
            ...
            prop="フェルト切り抜きのマグ（ステッチの縁つき）", effect="湯気が3筋"),
 ...
 dict(n="011", meaning="おやすみ", cat=C, comp="seated_lying_back", tags=["seated_lying_back","prop_acting"],
  ...
  moving=["left_arm","right_arm","head","tail","prop"], fixed=["legs_or_feet","body"],
  ha="contact_line", roi=ROI_LIE, travel=False, bbox=LIE_BBOX, hip=[98,150], sh=[78,128],
  pve="抱き込んだ枕と沈んだ頬",
  cues=dict(eyes="閉じた弧", brows="力を抜いた水平", mouth="小さく閉じる",
            cheeks="枕に押されて沈む", hands="枕を両腕で抱える", posture="横向きに寝る",
            prop="フェルト切り抜きの枕（ステッチの縁つき）", effect="輪郭のステッチが最もゆるむ"),
  story=["横向きに寝て枕を抱え、目を閉じた完成した就寝の姿勢",
         "両腕を開いて枕から少し離し、体をわずかに反らす",
         "腕が枕を胸へ引き寄せる途中。尻尾が体から離れる",
         "枕を最も強く抱き込み、頭と頬が26px沈む。尻尾が体へ巻き付く",
         "腕の力が緩み、枕がわずかに戻るが頭は沈んだまま",
         "呼吸ひとつ分だけ胸が上下し、睡眠姿勢のまま保持する"],
  pat="F01 と F12 の頭中心Y座標が26px以上沈み、尻尾先端が別軌道で動く",
  intent="就寝のあいさつ", sil="横向きに寝て枕を抱えた最も横長",
  effect_name="ステッチの弛緩", prop_name="枕", deform="頬と頭の沈み込み",
 ...
 dict(n="012", meaning="またね", cat=C, comp="full_body", tags=["full_body"],
  ...
  moving=["right_arm","body","legs_or_feet","head","face_parts"], fixed=["tail"],
  ha="feet_center", roi=ROI_FEET, travel=True, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="高く上げて左右へ振る右手",
  cues=dict(eyes="片目をウインク", brows="上げた水平", mouth="開いた笑いの弧",
            cheeks="赤み", hands="右手を高く上げる", posture="やや斜め向きの直立",
            prop="", effect="振る手のステッチが尾を引く"),
  ...
  effect_name="手のステッチの残像", prop_name="", deform="",
...
ITEMS += [
 dict(n="013", meaning="にっこり", cat=P, comp="face_centered", tags=["face_centered"],
  ...
  effect_name="ステッチの緩やかな開き", prop_name="", deform="頬の膨らみ",
 ...
 dict(n="015", meaning="うれしい", cat=P, comp="full_body", tags=["full_body"],
  ...
  moving=["body","head","legs_or_feet","left_arm","right_arm","tail"], fixed=[],
  ha="body_center", roi=ROI_TORSO, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="宙に浮いた足と胸前の両拳",
  cues=dict(eyes="開いた笑い目", brows="上げた水平", mouth="開いた笑いの弧",
            cheeks="赤み", hands="胸の前に小さな両拳", posture="立位からの跳躍準備",
            prop="", effect="ステッチが跳ねて浮き上がる"),
  story=["胸前に両拳を構え、笑顔で立つ完成した喜びの姿勢",
         "膝を曲げてしゃがみ、拳を下へ引いて溜める",
         "膝が伸びて足が床から離れる途中。尻尾が下へ流れる",
  ...
  effect_name="ステッチの跳ね", prop_name="", deform="着地の潰れ",
 ...
 dict(n="016", meaning="やったー", cat=P, comp="full_body", tags=["full_body"],
  ...
  effect_name="ステッチの最大張力", prop_name="", deform="着地の縦潰れ",
 ...
 dict(n="017", meaning="大好き", cat=P, comp="upper_body", tags=["upper_body","prop_acting"],
  ...
  moving=["left_arm","right_arm","prop","head","face_parts"], fixed=["legs_or_feet","body","tail"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="体の前で抱えた大きなハート",
  cues=dict(eyes="幸せに閉じた弧", brows="穏やかに上げる", mouth="小さく閉じた笑い",
            cheeks="濃い赤み", hands="大きなハートを両腕で抱える", posture="やや後傾の直立",
            prop="フェルト切り抜きの大きなハート（ステッチの縁つき）", effect=""),
 ...
 dict(n="018", meaning="照れる", cat=P, comp="face_centered", tags=["face_centered"],
  ...
  moving=["left_arm","right_arm","face_parts","head"], fixed=["legs_or_feet","body","tail"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="頬に当てた両手と濃く染まった頬",
  cues=dict(eyes="伏し目の弧", brows="八の字に上げる", mouth="小さくすぼめる",
            cheeks="最も濃い赤み", hands="両手を頬へ当てる", posture="肩をすぼめた直立",
            prop="", effect="頬のステッチがほつれて糸端が出る"),
  ...
  effect_name="頬ステッチのほつれ", prop_name="", deform="肩のすぼめ",
...
ITEMS += [
 ...
 dict(n="020", meaning="わくわく", cat=P, comp="upper_body", tags=["upper_body"],
  ...
  moving=["left_arm","right_arm","body","legs_or_feet","head"], fixed=["tail"],
  ha="hip", roi=ROI_HIP, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="交互に前へ突き出す両拳",
  cues=dict(eyes="大きく見開いた丸", brows="高く上げる", mouth="開いた期待の楕円",
            cheeks="赤み", hands="胸の前に両拳を構える", posture="前傾姿勢",
            prop="", effect="ステッチが波を打って走る"),
  ...
  effect_name="ステッチの走り", prop_name="", deform="",
 ...
 dict(n="022", meaning="すごい", cat=P, comp="upper_body", tags=["upper_body","full_body","prop_acting"],
  ...
  cues=dict(eyes="星形の瞳", brows="高く上げる", mouth="大きく開いた感嘆の口",
            ...
            prop="フェルト切り抜きの大きな星（ステッチの縁つき）", effect=""),
 ...
 dict(n="023", meaning="拍手", cat=P, comp="face_centered", tags=["face_centered","upper_body"],
  ...
  moving=["left_arm","right_arm","face_parts"], fixed=["legs_or_feet","body","head","tail"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="胸の前で開閉する左右対称の両手",
  cues=dict(eyes="細めた笑い目", brows="上げた水平", mouth="開いた笑いの弧",
...
ITEMS += [
 dict(n="025", meaning="悲しい", cat=T, comp="full_body", tags=["full_body","deformation_or_effect_led"],
  ...
  effect_name="ステッチの全体弛緩", prop_name="", deform="全身の段階的沈み込み",
 ...
 dict(n="026", meaning="泣く", cat=T, comp="face_centered", tags=["face_centered"],
  ...
  moving=["right_arm","effect","face_parts","head"], fixed=["legs_or_feet","body","left_arm","tail"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="右目から落ちる一粒の涙",
  cues=dict(eyes="潤んだ目、右目に涙", brows="八の字に上げる", mouth="への字に歪む",
            cheeks="", hands="右手を目元へ添える", posture="やや前かがみ",
            prop="", effect="一粒の涙（ステッチの縁つき）"),
 ...
 dict(n="027", meaning="怒る", cat=T, comp="full_body", tags=["full_body","deformation_or_effect_led"],
  ...
  cues=dict(eyes="つり上げた鋭い目", brows="強く下げて寄せる", mouth="歯を食いしばる",
            ...
            prop="", effect="頭上に赤い怒り記号（ステッチの縁つき）"),
 ...
 dict(n="028", meaning="イライラ", cat=T, comp="full_body", tags=["full_body"],
  ...
  moving=["legs_or_feet","tail"], fixed=["body","head","left_arm","right_arm"],
  ha="body_center", roi=ROI_TORSO, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="組んだ腕と床を叩く片足",
 ...
 dict(n="029", meaning="すねる", cat=T, comp="seated_lying_back", tags=["seated_lying_back","full_body"],
  ...
  moving=["body","head","tail","left_arm","right_arm"], fixed=["legs_or_feet"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  ...
  story=["斜めに背を向け、肩越しに横目で振り返って頬を膨らませた完成ポーズ",
         ...
         "体が正面から背面へ回転する途中。尻尾が遠心力で開く",
         "完全に背を向ける。体幅が38px変化し尻尾が払われ切る",
         "尻尾が体側へ戻り、肩がわずかに落ちる",
         "頭だけが肩越しに戻り、横目で振り返る"],
  pat="F01 と F12 の体幅が38px以上変化し、正面・背面・肩越しの3シルエットが区別できる",
  intent="拗ねる・不満を示す", sil="40個中唯一の後ろ向きと肩越しの振り返り",
  effect_name="尻尾の払い", prop_name="", deform="頬の膨らみ",
 ...
 dict(n="030", meaning="困る", cat=T, comp="face_centered", tags=["face_centered"],
  ...
  moving=["right_arm","head","face_parts","stitch_line"], fixed=["legs_or_feet","body","left_arm"],
  ha="feet_center", roi=ROI_FEET, travel=False, bbox=STAND_BBOX, hip=[90,128], sh=[90,100],
  pve="頭をかく右手と八の字の眉",
  cues=dict(eyes="困った半開きの目", brows="八の字に強く下げる", mouth="斜めに歪んだ小さな口",
            cheeks="", hands="右手を頭へ、左手を下げる", posture="非対称に傾いた直立",
            prop="", effect="頭のステッチが片側だけほつれる"),
  ...
  effect_name="片側ステッチのほつれ", prop_name="", deform="",
 ...
 dict(n="032", meaning="焦る", cat=T, comp="full_body", tags=["full_body","deformation_or_effect_led"],
  ...
  cues=dict(eyes="小さく縮んだ瞳", brows="強く上げて寄せる", mouth="大きく開いた慌ての口",
            ...
            prop="", effect="汗が4粒、外向きに飛ぶ（ステッチの縁つき）"),
...
ITEMS += [
 dict(n="033", meaning="OK!", cat=S, comp="symbol", tags=["symbol"],
  ...
  pve="太い丸文字で組み上がった OK!",
  cues=dict(NO_CUES, effect="3文字が衝突する瞬間の衝撃線", prop="フェルト切り抜きの英字3パーツ（各ステッチの縁つき）"),
 ...
 dict(n="034", meaning="ハート", cat=S, comp="symbol", tags=["symbol","prop_acting"],
  ...
  pve="斜めに並んだ大中小3つのハート",
  cues=dict(NO_CUES, effect="", prop="フェルト切り抜きの小箱と3つのハート（各ステッチの縁つき）"),
 ...
 dict(n="035", meaning="汗", cat=S, comp="symbol", tags=["symbol"],
  ...
  pve="外向きに並んだ大中小3粒の汗",
  cues=dict(NO_CUES, effect="", prop="フェルト切り抜きの水滴3粒（各ステッチの縁つき）"),
 ...
 dict(n="036", meaning="!?", cat=S, comp="symbol", tags=["symbol"],
  ...
  pve="重なった太い感嘆符と疑問符",
  cues=dict(NO_CUES, effect="衝突点の衝撃線", prop="フェルト切り抜きの ! と ?（各ステッチの縁つき）"),
 ...
 dict(n="037", meaning="？", cat=S, comp="symbol", tags=["symbol"],
  ...
  pve="傾いた大きな疑問符",
  cues=dict(NO_CUES, effect="", prop="フェルト切り抜きの曲線本体と点（各ステッチの縁つき）"),
 ...
 dict(n="038", meaning="キラキラ", cat=S, comp="symbol", tags=["symbol"],
  ...
  pve="異なる角度で光る大中小3つの星",
  cues=dict(NO_CUES, effect="", prop="フェルト切り抜きの星3つ（各ステッチの縁つき）"),
 ...
 dict(n="039", meaning="炎", cat=S, comp="symbol", tags=["symbol","deformation_or_effect_led"],
  ...
  cues=dict(NO_CUES, effect="", prop="フェルト切り抜きの火種と三層の炎（各ステッチの縁つき）"),
 ...
 dict(n="040", meaning="zzz", cat=S, comp="symbol", tags=["symbol"],
  ...
  cues=dict(NO_CUES, effect="", prop="フェルト切り抜きの小文字 z 3つ（各ステッチの縁つき）"),
